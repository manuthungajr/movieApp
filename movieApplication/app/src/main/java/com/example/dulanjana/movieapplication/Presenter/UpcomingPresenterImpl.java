...
import com.example.dulanjana.movieapplication.View.UpcomingFragmentView;
...
public class UpcomingPresenterImpl implements UpcomingPresenter {

    UpcomingFragmentView upcomingFragmentView;
    Context context;


    public UpcomingPresenterImpl(UpcomingFragmentView upcomingFragmentView, Context context) {
        this.upcomingFragmentView = upcomingFragmentView;
    ...
    public void fetchUpComingMovies() {
        ...
        String mJSONURLString = "https://api.themoviedb.org/3/movie/upcoming?api_key=21cf9e58fa9fb18d1769658101c2fa34&page=1";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            upcomingFragmentView.OnSuccess(movieList);
                            int i =  2 +5;
